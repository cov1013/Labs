...
namespace cov1013
{
	...
	// 생성자
	//////////////////////////////////////////////////////////////////////////////////
	CMonitorServer_Lan::CMonitorServer_Lan()
	{
		m_bLoop = false;
		m_bRunFlag = false;
	...
	// 서버 실행
	//////////////////////////////////////////////////////////////////////////////////
	bool CMonitorServer_Lan::Run(void)
	{
		//----------------------------------------------------------------------
		// 중복 실행 방지
		//----------------------------------------------------------------------
	...
	// 서버 종료
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::Quit(void)
	{
		//----------------------------------------------------------------------
		// 서버가 실행중이라면 완벽한 종료
		//----------------------------------------------------------------------
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	bool CMonitorServer_Lan::OnConnectionRequest(const WCHAR* ConnectIP, const WORD ConnectPORT)
	{
		return false;
	}
	...
	// 새로운 클라이언트가 접속했다.
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnClientJoin(const SESSION_ID SessionID)
	{
	...
	// 기존 클라이언트가 연결 종료됐다.
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnClientLeave(const SESSION_ID SessionID)
	{
	...
	// 패킷을 수신 받았다.
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnRecv(const SESSION_ID SessionID, CPacket* pRecvPacket)
	{
	...
	// 패킷을 송신했다.
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnSend(const SESSION_ID SessionID, const DWORD dwTransferred)
	{
	}

	//////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnWorkerThreadBegin(void)
	{
	}

	//////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnWorkerThreadEnd(void)
	{
	}
	...
	// 라이브러리에서 에러가 발생했다.
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::OnError(const en_ERROR_CODE eErrCode, const SESSION_ID SessionID)
	{
		switch (eErrCode)
		{
	...
	// 패킷 처리
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::PacketProcedure(SESSION_ID SessionID, CPacket* pRecvPacket)
	{
		WORD Type;
		*pRecvPacket >> Type;
	...
	// 로그인 요청 패킷 처리
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::PacketProcedure_Login(SESSION_ID SessionID, CPacket* pRecvPacket)
	{
		//----------------------------------------------------------------------
		// [예외] 존재하는 세션인가?
		//----------------------------------------------------------------------
	...
	// 데이터 갱신 요청 패킷 처리
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::PacketProcedure_DataUpdate(SESSION_ID SessionID, CPacket* pRecvPacket)
	{
		//----------------------------------------------------------------------
		// [예외] 존재하는 세션인가?
		//----------------------------------------------------------------------
	...
	// 새로운 서버 생성
	//////////////////////////////////////////////////////////////////////////////////
	CMonitorServer_Lan::st_SERVER* CMonitorServer_Lan::CreateServer(const SESSION_ID SessionID)
	{
	...
	// 기존 서버 찾기
	//////////////////////////////////////////////////////////////////////////////////
	CMonitorServer_Lan::st_SERVER* CMonitorServer_Lan::FindServer(const SESSION_ID SessionID)
	{
	...
	// 기존 서버 삭제
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::DeleteServer(const SESSION_ID SessionID, st_SERVER* pServer)
	{
		LockServers();
	...
	// 서버 관리 컨테이너 정리
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::ClearServers(void)
	{
	...
	// 서버 관리 컨테이너 락걸기
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::LockServers(void)
	{
	...
	// 서버 관리 컨테이너 락풀기
	//////////////////////////////////////////////////////////////////////////////////
	void CMonitorServer_Lan::UnlockServers(void)
	{
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall CMonitorServer_Lan::DBWroteThread(void* lpParam)
	{
		return ((CMonitorServer_Lan*)lpParam)->DBWroteThread_Procedure();
	}
	int CMonitorServer_Lan::DBWroteThread_Procedure(void)
	{
		DWORD StartTime;
		DWORD ElapsedTime;
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall CMonitorServer_Lan::HeartBeatThread(void* lpParam)
	{
		return ((CMonitorServer_Lan*)lpParam)->HeartBeatThread_Procedure();
	}
	int CMonitorServer_Lan::HeartBeatThread_Procedure(void)
	{
		DWORD NowTime;
		st_SERVER* pServer;
		unordered_map<SESSION_ID, st_SERVER*>::iterator ServerIter;
