...
namespace cov1013
{
	...
	// 
	///////////////////////////////////////////////////////////////////
	bool CNetSession::Disconnect(void)
	{
	...
	// 
	///////////////////////////////////////////////////////////////////
	bool CNetSession::SendPacket(CPacket* pPacket)
	{
		pPacket->AddRef();
	...
	// 
	///////////////////////////////////////////////////////////////////
	void CNetSession::SetMode_ToGame(void)
	{
	...
	void CNetSession::SetLog(const int Logic)
	{
