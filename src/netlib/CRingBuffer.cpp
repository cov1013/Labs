...
namespace cov1013
{
	...
	// 버퍼 사이즈 얻기
	//////////////////////////////////////////////////////////////////
	const int CRingBuffer::GetBufferSize(void) const
	{
	...
	// 읽기 위치 얻기
	//////////////////////////////////////////////////////////////////
	char* CRingBuffer::GetReadPos(void) const
	{
	...
	// 쓰기 위치 얻기
	//////////////////////////////////////////////////////////////////
	char* CRingBuffer::GetWritePos(void) const
	{
	...
	// 버퍼 시작 포인터 얻기
	//////////////////////////////////////////////////////////////////
	char* CRingBuffer::GetBufferPtr(void) const
	{
	...
	// 버퍼가 비어있는지 확인
	//////////////////////////////////////////////////////////////////
	const bool CRingBuffer::IsEmpty(void) const
	{
	...
	// 버퍼가 꽉 차있는지 확인
	//////////////////////////////////////////////////////////////////
	const bool CRingBuffer::IsFull(void)
	{
		if (0 == GetFreeSize())
		{
			return true;
	...
	// 사용중인 사이즈 얻기
	//////////////////////////////////////////////////////////////////
	const int CRingBuffer::GetUseSize(void)
	{
	...
	// 사용가능 사이즈 얻기
	//////////////////////////////////////////////////////////////////
	const int CRingBuffer::GetFreeSize(void)
	{
		int iWritePos = m_iWritePos;
		int iReadPos = m_iReadPos;
	...
	//////////////////////////////////////////////////////////////////
	const int CRingBuffer::GetNonBrokenPutSize(void)
	{
		int iWritePos = m_iWritePos;
		int iReadPos = m_iReadPos;
	...
	//////////////////////////////////////////////////////////////////
	const int CRingBuffer::GetNonBrokenGetSize(void)
	{
		int	iWritePos = m_iWritePos;
		int	iReadPos = m_iReadPos;
	...
	// 큐에 데이터 넣기
	//////////////////////////////////////////////////////////////////
	int CRingBuffer::Put(const char* bypSource, int iSize)
	{
		////////////////////////////////////////////////////////////////
		// Case 1 :
		// ReadPos 이동 가능
	...
	// 큐에서 데이터 뽑기
	//////////////////////////////////////////////////////////////////
	int CRingBuffer::Get(char* bypDest, int iSize)
	{
		////////////////////////////////////////////////////////////////
		// Case 1 :
		// WritePos 이동 가능
	...
	//////////////////////////////////////////////////////////////////
	int CRingBuffer::Peek(char* bypDest, int iSize)
	{
		////////////////////////////////////////////////////////////////
		// Case 1 :
		// WritePos 이동 가능
	...
	// 쓰기 포인터 이동
	//////////////////////////////////////////////////////////////////
	int CRingBuffer::MoveWritePos(const int iSize)
	{
		//--------------------------------------------------------------
	...
	// 읽기 포인터 이동
	//////////////////////////////////////////////////////////////////
	int CRingBuffer::MoveReadPos(const int iSize)
	{
		//--------------------------------------------------------------
		// 이동한 값이 BufferSize를 초과할 경우 나머지 연산의 나머지가 위치가 된다.
		//--------------------------------------------------------------
