...
namespace cov1013
{
	...
	public:
		...
		struct st_SESSION
		{
			...
			int							PacketCount;
			CPacket*					Packets[en_SEND_PACKET_MAX];
	...
	protected:
		...
		virtual void OnRecv(const SESSION_ID SessionID, CPacket* pRecvPacket) = 0;
	...
	private:
		...
		CLockFreeStack<short>					m_Indexes;
