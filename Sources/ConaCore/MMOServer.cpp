...
namespace cov1013
{
	...
	// 
	///////////////////////////////////////////////////////////////////////////////////
	bool MMOServer::SendPacket(const SESSION_ID SessionID, PacketBuffer* pSendPacket)
	{
		// TODO
		return true;
	}
	...
	{
		PacketBuffer* pDregsPacket = NULL;
	...
	// 송신 완료 프로시저
	///////////////////////////////////////////////////////////////////////////////////
	void MMOServer::SendProc(MMOSession* pSession, const DWORD dwTransferred)
	{
	...
	//
	///////////////////////////////////////////////////////////////////////////////////
	void MMOServer::OnGame_Update(void)
	{
	}
	...
	//
	///////////////////////////////////////////////////////////////////////////////////
	void MMOServer::OnAuth_Update(void)
	{
	}
	...
	int MMOServer::AuthThread_Procedure(void)
	{
		st_CONNECT_INFO ConnectInfo;
		MMOSession*	pSession = NULL;
		PacketBuffer*		pRecvPacket;
		en_THREAD_MODE	eThreadMode;
