...
namespace cov1013
{
	...
	// 서버 컨트롤러
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::Controler(void)
	{
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	bool MonitorServer::OnConnectionRequest(const WCHAR* ConnectIP, const WORD ConnectPORT)
	{
		return false;
	}
	...
	// 새로운 클라이언트가 접속했다.
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnClientJoin(const SESSION_ID SessionID)
	{
	...
	// 기존 클라이언트가 연결 종료됐다.
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnClientLeave(const SESSION_ID SessionID)
	{
		//----------------------------------------------------------------------
		// [예외] 존재하는 세션인가?
	...
	// 패킷을 수신 받았다.
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnRecv(const SESSION_ID SessionID, PacketBuffer* pRecvPacket)
	{
	...
	// 패킷을 송신했다.
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnSend(const SESSION_ID SessionID, const DWORD dwSendLength)
	{
	}

	//////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnWorkerThreadBegin(void)
	{
	}

	//////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnWorkerThreadEnd(void)
	{
	}
	...
	// 라이브러리에서 에러가 발생했다.
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::OnError(const en_ERROR_CODE eErrCode, const SESSION_ID SessionID)
	{
		switch (eErrCode)
		{
	...
	// 패킷 처리
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::PacketProcedure(SESSION_ID SessionID, PacketBuffer* pRecvPacket)
	{
		WORD Type;
		*pRecvPacket >> Type;
	...
	// 로그인 요청 패킷 처리
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::PacketProcedure_Login(SESSION_ID SessionID, PacketBuffer* pRecvPacket)
	{
		st_CLIENT* pClient = FindClient(SessionID);
		if (nullptr == pClient)
		{
	...
	// 로그인 응답 패킷 만들기
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::MakePacket_ResLogin(PacketBuffer* pSendPacket, const BYTE Status)
	{
	...
	// 툴에 송신해줄 데이터 패킷 만들기
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::MakePacket_UpdateData(PacketBuffer* pSendPacket, const BYTE ServerNo, const BYTE DataType, const int DataValue, const int TimeStamp)
	{
	...
	// 새로운 클라이언트 생성
	//////////////////////////////////////////////////////////////////////////////////
	MonitorServer::st_CLIENT* MonitorServer::CreateClient(const SESSION_ID SessionID)
	{
	...
	// 기존 클라이언트 찾기
	//////////////////////////////////////////////////////////////////////////////////
	MonitorServer::st_CLIENT* MonitorServer::FindClient(const SESSION_ID SessionID)
	{
	...
	// 기존 클라이언트 삭제
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::DeleteClient(const SESSION_ID SessionID, st_CLIENT* pClient)
	{
		LockClients();
	...
	// 클라이언트 관리 컨테이너 정리
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::ClearClients(void)
	{
	...
	// 클라이언트 관리 컨테이너 락걸기
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::LockClients(void)
	{
	...
	// 클라이언트 관리 컨테이너 락걸기
	//////////////////////////////////////////////////////////////////////////////////
	void MonitorServer::UnlockClients(void)
	{
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall MonitorServer::MonitorThread(void* lpParam)
	{
		return ((MonitorServer*)lpParam)->MonitorThread_Procedure();
	}
	int MonitorServer::MonitorThread_Procedure(void)
	{
		CPUMeter	CpuUsage;
		PerformaceDataHelper PDH(L"MonitorServer_Lan");
		WCHAR		szFileName[32];
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall MonitorServer::HeartBeatThread(void* lpParam)
	{
		return ((MonitorServer*)lpParam)->HeartBeatThread_Procedure();
	}

	int MonitorServer::HeartBeatThread_Procedure(void)
	{
		DWORD NowTime;
		st_CLIENT* pClient;
	...
	// 
	//////////////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall MonitorServer::SendThread(void* lpParam)
	{
		return ((MonitorServer*)lpParam)->SendThread_Procedure();
	}
	int MonitorServer::SendThread_Procedure(void)
	{
		...
		PacketBuffer* pSendPacket = nullptr;
			...
			for (ServerIter; ServerIter != ServerEnd; ++ServerIter)
			{
				...
				for (ClientIter; ClientIter != ClientEnd; ++ClientIter)
				{
					...
					case en_SERVER_TYPE::MASTER:
						pSendPacket = PacketBuffer::Alloc();
