...
namespace cov1013
{
	...
	void ChatServer::OnRecv(const SESSION_ID SessionID, PacketBuffer* pRecvPacket)
	{
		...
		pRecvPacket->AddRef(PacketBuffer::en_LOGIC::RECV_PROC + 20, SessionID);
#else
		pRecvPacket->AddRef();
#endif
	...
	//////////////////////////////////////////////////////////////////////////////////
	bool ChatServer::JobProcedure_RecvMessage(const SESSION_ID SessionID, PacketBuffer* pRecvPacket)
	{
		bool bResult = false;
		WORD wPacketType;
	...
	bool ChatServer::JobProcedure_RedisCompeleted(const SESSION_ID SessionID)
	{
		...
		// 로그인 응답 메세지 생성 후 송신
		//------------------------------------------------------------------
		PacketBuffer* pSendMSG = PacketBuffer::Alloc();
	...
	// 패킷 요청 처리 : 로그인 처리
	//////////////////////////////////////////////////////////////////////////////////
	bool ChatServer::PacketProcedure_Login(const SESSION_ID SessionID, PacketBuffer* pMessage)
	{
	...
	// 패킷 요청 처리 : 섹터 이동
	//////////////////////////////////////////////////////////////////////////////////
	bool ChatServer::PacketProcedure_SectorMove(const SESSION_ID SessionID, PacketBuffer* pMessage)
	{
	...
	// 패킷 요청 처리 : 채팅 송신
	//////////////////////////////////////////////////////////////////////////////////
	bool ChatServer::PacketProcedure_ChatMessage(const SESSION_ID SessionID, PacketBuffer* pMessage)
	{
		m_RecvChatMessage += 1; 
	...
	// 수신 패킷 만들기 : 로그인 응답
	//////////////////////////////////////////////////////////////////////////////////
	void ChatServer::MakePacket_Login(PacketBuffer* pSendMessage, const BYTE byStatus, const INT64 AccountNo)
	{
	...
	// 수신 패킷 만들기 : 섹터 이동 응답
	//////////////////////////////////////////////////////////////////////////////////
	void ChatServer::MakePacket_SectorMove(PacketBuffer* pSendMessage, const INT64 AccountNo, const WORD shSectorX, const WORD shSectorY)
	{
	...
	// 수신 패킷 만들기 : 채팅 송신 응답
	//////////////////////////////////////////////////////////////////////////////////
	void ChatServer::MakePacket_ChatMessage(PacketBuffer* pSendMessage, const INT64 AccountNo, const WCHAR* szID, const WCHAR* szNickName, const WORD shChatMessageLen, const WCHAR* szChatMessage)
	{
	...
	// 주변 섹터 전체 유저에게 패킷 송신
	//////////////////////////////////////////////////////////////////////////////////
	void ChatServer::SendPacket_Around(st_CLIENT* pClient, PacketBuffer* pSendMessage, const bool bSendMe)
	{
	...
	//////////////////////////////////////////////////////////////////////////////////
	void ChatServer::SendPacket_SectorOne(const int iX, const int iY, PacketBuffer* pSendMessage, const SESSION_ID ExceptSessionID)
	{
		//-----------------------------------------------
		// 1. 섹터를 찾는다
		//-----------------------------------------------
	...
	{
		CPUMeter	CpuUsage;
		PerformaceDataHelper		PDH(L"ChatServer");
...
//#endif
	...
	void ChatServer::CMonitorClient::OnRecv(PacketBuffer* pRecvPacket)
	{
	}
	...
	void ChatServer::CMonitorClient::MakePacket_Login(PacketBuffer* pSendPacket, const int ServerNo)
	{
		*pSendPacket << (WORD)en_PACKET_SS_MONITOR_LOGIN;
		*pSendPacket << ServerNo;
	}

	void ChatServer::CMonitorClient::MakePacket_DataUpdate(PacketBuffer* pSendPacket, const BYTE DataType, const int DataValue, int TimeStamp)
	{
