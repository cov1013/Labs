...
namespace covEngine
{
	...
	PerformaceDataHelper::~PerformaceDataHelper()
	{
	}

	void PerformaceDataHelper::Collect(void)
	{
		PdhCollectQueryData(m_szQuery);
	}

	const LONGLONG PerformaceDataHelper::GetProcessCommitMemory(void)
	{
	...
	const LONGLONG PerformaceDataHelper::GetProcessNonPagedMemory(void)
	{
		PDH_FMT_COUNTERVALUE CounterValue;
	...
	const LONGLONG PerformaceDataHelper::GetAvailableMemory(void)
	{
		PDH_FMT_COUNTERVALUE CounterValue;
	...
	const LONGLONG PerformaceDataHelper::GetNonPagedMemory(void)
	{
		PDH_FMT_COUNTERVALUE CounterValue;
	...
	const LONGLONG PerformaceDataHelper::GetRecvBytes(void)
	{
	...
	const LONGLONG PerformaceDataHelper::GetSendBytes(void)
	{
	...
	const LONGLONG PerformaceDataHelper::GetTCPv4Retransmitted(void)
	{
		PDH_FMT_COUNTERVALUE CounterValue;
	...
	const double PerformaceDataHelper::GetPageFaults(void)
	{
		PDH_FMT_COUNTERVALUE CounterValue;
	...
	bool PerformaceDataHelper::AddNetworkInterfaces(void)
	{
		bool	bErr = false;
		WCHAR* szCur = NULL;
