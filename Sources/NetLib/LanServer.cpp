...
namespace covEngine
{
	LanServer::LanServer()
	{
		...
		Logger::Logger(L"../Logs_Lanserver", eLOG_LEVEL_DEBUG);
	...
	// Network I/O 정지
	//////////////////////////////////////////////////////////////////////
	void LanServer::Stop(int StopCode)
	{
		switch (StopCode)
		{
		case 1:
	...
	// 패킷 송신
	//////////////////////////////////////////////////////////////////////
	bool LanServer::SendPacket(const SESSION_ID SessionID, PacketBuffer* pPacket)
	{
	...
	// 
	/////////////////////////////////////////////////////////////////////////
	bool LanServer::Disconnect(const SESSION_ID SessionID)
	{
		st_SESSION* pSession = m_Sessions[GET_SESSION_INDEX(SessionID)];
		InterlockedIncrement16(&pSession->IOCount);
	...
	// 세션수 출력
	/////////////////////////////////////////////////////////////////////////
	const int LanServer::GetSessionCount(void)
	{
	...
	// 인덱스수 출력
	/////////////////////////////////////////////////////////////////////////
	const int LanServer::GetIndexesCount(void)
	{
	...
	// 세션 생성
	/////////////////////////////////////////////////////////////////////////
	LanServer::st_SESSION* LanServer::NewSession(const SOCKET ClientSocket)
	{
	...
	// 세션 정리
	/////////////////////////////////////////////////////////////////////////
	bool LanServer::ReleaseSession(st_SESSION* pSession)
	{
		//--------------------------------------------------------
	...
	// 세션 연결 종료 (내부용)
	/////////////////////////////////////////////////////////////////////////
	bool LanServer::Disconnect(st_SESSION* pSession)
	{
		InterlockedIncrement16(&pSession->IOCount);
	...
	// WSARecv 등록
	/////////////////////////////////////////////////////////////////////////
	void LanServer::RecvPost(st_SESSION* pSession)
	{
		DWORD	dwFlags = 0;
		WSABUF	Buffers[2];
		int		iBufferCount;
	...
	// WSASend 등록
	/////////////////////////////////////////////////////////////////////////
	bool LanServer::SendPost(st_SESSION* pSession)
	{
		do
		{
	...
	// 수신 완료 처리
	/////////////////////////////////////////////////////////////////////////
	void LanServer::RecvProc(st_SESSION* pSession, const DWORD dwTransferred)
	{
		int iResult;
		...
		while (true)
		{
			...
			//--------------------------------------------------------
			pSession->RecvQ.MoveReadPos(sizeof(PacketBuffer::st_PACKET_LAN::Len));
	...
	// 송신 완료 처리
	/////////////////////////////////////////////////////////////////////////
	void LanServer::SendProc(st_SESSION* pSession, const DWORD dwTransferred)
	{
	...
	// 
	/////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall LanServer::AcceptThread(void* lpParam)
	{
		return ((LanServer*)lpParam)->AcceptThreadProcedure();
	}
	int LanServer::AcceptThreadProcedure(void)
	{
		SOCKET		ClientSocket;
		SOCKADDR_IN	ClientAddr;
		int			addrlen = sizeof(ClientAddr);
	...
	// 
	/////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall LanServer::IOCPWorkerThread(void* lpParam)
	{
		return ((LanServer*)lpParam)->IOCPWorkerThreadProcedure();
	}
	int LanServer::IOCPWorkerThreadProcedure(void)
	{
		DWORD		dwTransferred;
