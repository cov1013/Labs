...
namespace cov1013
{
	...
	// 서버 컨트롤러
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::Controler(void)
	{
	...
	// 
	///////////////////////////////////////////////////////////////////////////
	bool CLoginServer::OnConnectionRequest(const WCHAR* ConnectIP, const WORD ConnectPORT)
	{
		return false;
	}
	...
	// 새로운 클라이언트가 접속했다.
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::OnClientJoin(const SESSION_ID SessionID)
	{
	...
	// 기존 클라이언트가 연결 종료됐다.
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::OnClientLeave(const SESSION_ID SessionID)
	{
	...
	// 패킷을 수신받았다.
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::OnRecv(const SESSION_ID SessionID, CPacket* pRecvPacket)
	{
	...
	// 
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::OnSend(const SESSION_ID SessionID, const DWORD dwSendLength)
	{
	}
	...
	// 에러 처리
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::OnError(const en_ERROR_CODE eErrCode, const SESSION_ID SessionID)
	{
		switch (eErrCode)
		{
	...
	// 로그인 응답 메세지 만들기
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::MakePacket_ResLogin(CPacket* pSendPacket, const INT64 AccountNo, const BYTE Status, const WCHAR* ID, const WCHAR* NickName, const WCHAR* GameServerIP, const USHORT GameServerPort, const WCHAR* ChatServerIP, const USHORT ChatServerPort)
	{
	...
	// 패킷 처리
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::PacketProcedure(const SESSION_ID SessionID, CPacket* pRecvPacket)
	{
		WORD Type;
		*pRecvPacket >> Type;
	...
	// 로그인 처리 프로시저
	///////////////////////////////////////////////////////////////////////////
	bool CLoginServer::PacketProcedure_Login(const SESSION_ID SessionID, CPacket* pRecvPacket)
	{
	...
	// 클라이언트 생성
	///////////////////////////////////////////////////////////////////////////
	CLoginServer::st_CLIENT* CLoginServer::CreateClient(const SESSION_ID SessionID)
	{
	...
	// 클라이언트 찾기
	///////////////////////////////////////////////////////////////////////////
	CLoginServer::st_CLIENT* CLoginServer::FindClient(const SESSION_ID SessionID)
	{
	...
	// 클라이언트 삭제
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::DeleteClient(const SESSION_ID SessionID, st_CLIENT* pClient)
	{
		LockClients();
	...
	// 모든 클라이언트 정리
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::ClearClients(void)
	{
	...
	// 클라이언트 컨테이너 락 걸기
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::LockClients(void)
	{
	...
	// 클라이언트 컨테이너 락 풀기
	///////////////////////////////////////////////////////////////////////////
	void CLoginServer::UnlockClients(void)
	{
	...
	// 
	///////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall CLoginServer::MonitorThread(void* lpParam)
	{
		return ((CLoginServer*)lpParam)->MonitorThread_Procedure();
	}
	int CLoginServer::MonitorThread_Procedure(void)
	{
		CCpuUsage	CpuUsage;
		CPDH		PDH(L"LoginServer");
		WCHAR		szFileName[32];
	...
	// 
	///////////////////////////////////////////////////////////////////////////
	unsigned int __stdcall CLoginServer::HeartBeatThread(void* lpParam)
	{
		return ((CLoginServer*)lpParam)->HeartBeatThread_Procedure();
	}
	int CLoginServer::HeartBeatThread_Procedure(void)
	{
		DWORD NowTime;
	...
	unsigned int __stdcall CLoginServer::MonitorServerConnectThread(void* lpParam)
	{
		return ((CLoginServer*)lpParam)->MonitorServerConnectThread_Procedure();
	}

	int CLoginServer::MonitorServerConnectThread_Procedure(void)
	{
		WCHAR	BIND_IP[16];
		WCHAR	SERVER_IP[16];
		WORD	SERVER_PORT;
	...
	//=================================================================================
	CLoginServer::CMonitorClient::CMonitorClient()
	{
	...
	void CLoginServer::CMonitorClient::SendPacket_UpdateData(const int DataValues[], const int DataCount)
	{
		//--------------------------------------------------------------
		// [예외] 연결이 끊어져있다면 리턴
		//--------------------------------------------------------------
	...
	void CLoginServer::CMonitorClient::OnEnterJoinServer(void)
	{
		//-------------------------------------------------------
		// 로그인 요청 패킷 보내기
		//-------------------------------------------------------
	...
	void CLoginServer::CMonitorClient::OnLeaveServer(void)
	{
		m_bConnectedFlag = false;
	}

	void CLoginServer::CMonitorClient::OnRecv(CPacket* pRecvPacket)
	{
	}

	void CLoginServer::CMonitorClient::OnSend(int sendsize)
	{
	}

	void CLoginServer::CMonitorClient::OnWorkerThreadBegin(void)
	{
	}

	void CLoginServer::CMonitorClient::OnWorkerThreadEnd(void)
	{
	}

	void CLoginServer::CMonitorClient::OnError(int errorcode, wchar_t* szMsg)
	{
	}

	void CLoginServer::CMonitorClient::MakePacket_Login(CPacket* pSendPacket, const int ServerNo)
	{
		*pSendPacket << (WORD)en_PACKET_SS_MONITOR_LOGIN;
		*pSendPacket << ServerNo;
	}

	void CLoginServer::CMonitorClient::MakePacket_DataUpdate(CPacket* pSendPacket, const BYTE DataType, const int DataValue, int TimeStamp)
	{
